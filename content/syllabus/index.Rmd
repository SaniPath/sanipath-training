...
This course is meant to provide an in-depth training for the application of the SaniPath Exposure Assessment Tool in urban and peri-urban environments. It aims to teach the methods and tools used in this exposure assessment approach and guide participants in how to apply the tool in their specific context. No prerequisites or previous experience is required but it is beneficial for participants to have a basic public health and WASH background.

This online course is not meant to be a substitute for a full training course for the SaniPath Exposure Assessment Tool and participation in virtual trainings via Zoom will be essential to mastering skills and receiving a SaniPath training certificate.
...
[Ted Laderas, PhD](https://github.io)  
laderasdfesfqeast@ohsu.edu  
